const SvgOrion = ({ toggleModal }) => {
    ...
    >
        ...
        <g className="maps-svg-avernus">
            <circle cx="678" cy="685" r="16" fill="#2C7652"
        ...
        <g className="maps-svg-triton">
            <circle cx="288" cy="669" r="16" fill="#2C7652"
        ...
        <g className="maps-svg-pertam">
            <circle cx="216" cy="538" r="16" fill="#2C7652"
        ...
        <g className="maps-svg-treossa">
            <circle cx="785" cy="538" r="16" fill="#2C7652"
        ...
        <g className="maps-svg-alien">
            <circle cx="857" cy="202" r="16" fill="#2C7652"
        ...
        <g className="maps-svg-mars">
            <circle cx="440" cy="139" r="16" fill="#2C7652"
        ...
        <g className="maps-svg-terra">
            <circle cx="337" cy="240" r="16" fill="#2C7652"
        ...
        <g className="maps-svg-titan">
            <circle cx="838" cy="177" r="8" fill="#2C7652"
        ...
        <g className="maps-svg-europa">
            <circle cx="432" cy="110" r="8" fill="#2C7652"
        ...
        <g className="maps-svg-luna">
            <circle cx="319" cy="212" r="8" fill="#2C7652"
        ...
        <g className="maps-svg-rothis">
            <circle cx="189" cy="916" r="8" fill="#2C7652"
        ...
        <g className="maps-svg-overvent">
            <circle cx="540" cy="538" r="109.5" fill="#2C7652"
